...
assert.strictEqual(lightFallback.background, "#fffcf0")
assert.strictEqual(lightFallback.foreground, "#100f0f")
assert.strictEqual(lightFallback.accent, "#205ea6")
assert.strictEqual(lightFallback.surface, "#f2f0e5")
assert.strictEqual(lightFallback.inset, "#e6e4d9")
assert.strictEqual(lightFallback.selection, "#dad8ce")
assert.strictEqual(lightFallback.border, "#b7b5ac")
assert.strictEqual(lightFallback.urgent, "#af3029")
assert.strictEqual(lightFallback.warning, "#855b00")
assert.strictEqual(lightFallback.success, "#526600")
