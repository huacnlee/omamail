...
export { VERSION, EMAIL_PATTERN, emptyList, trimmed, isObject, parseJson, isSerializedList, isValidEmail, accountId, PROVIDERS, DEFAULT_PROVIDER, normalizeProvider, portOr, makeImapSettings, makeAccount, copyList, indexOfId, find, active, count, hasSavedAccounts, label, add, nextActiveId, remove, removeAt, removalRequest, confirmRemoval, discardDraftAt, setActive, load, serialize }
