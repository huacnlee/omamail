...
export { MAX_HEADER_LENGTH, MAX_ENTRIES, entries, percentDecode, headerSafe, parseMailto, isPublicWebUrl, isPostableUrl, empty, from, fromMessage, fromHeaders, plan, label, explanation, postBody, postContentType }
