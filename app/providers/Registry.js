...
export { capabilities, mailbox, define, ALL, DEFAULT_ID, ids, get, exists, isConnectable, unavailableReason, can, mailboxes, mailboxIndex, mailboxFor, hasMailbox, query, cachedSummaryInSearch, labelQuery, unreadQuery, badge, summary, mark, logo, authKind, usesOAuth, usesPassword, usesCli, webMessageUrl, webBoxUrl, webHomeUrl, clientUrl }
