...
Item {
  ...
  function applyWindowPrefs(raw) {
    ...
    if (parsed && typeof parsed === "object") {
      ...
      // A window written before there were three ways to read a message knew
      // only whether the text had been asked for.
      bodyMode = Html.bodyModeOf(parsed.bodyMode,
        parsed.plainTextForced === true ? "plain" : "reader")
